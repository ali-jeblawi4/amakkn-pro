...
export function BuildYourWebsiteSection() {
  const features = [
    {
    ...
    },
    {
      ...
      description:
        "We provide you with all the features that make it easy for you to manage your website in a simple and easy-to-use way.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Watch our guide on YouTube",
      description:
        "Watch our step-by-step guide on YouTube to learn how to create your real estate website with AmakknPro.",
    ...
    },
    {
      ...
      description:
        "Launch your real estate website instantly with just a few clicks — no technical skills required.",
    ...
    >
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          We enable you to build your website in one minute, with simple and
          easy-to-use steps
        </p>
      </div>
      ...
      <div className="shadow-2xl group  h-[450px] w-[700px]">
        <div className="flex flex-1 h-[450px] w-[700px] flex-col">
          <img
            ...
            alt="header"
            className="h-[450px] w-[700px] aspect-square object-cover object-left-top rounded-sm"
          />
        </div>
      </div>
