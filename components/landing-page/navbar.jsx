...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      <button className="cursor-pointer w-40 transform rounded-lg bg-black px-2 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
        Start Free Now
      </button>
    </div>
  );
