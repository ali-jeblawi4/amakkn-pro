...
export const SectionHighlight = ({
  ...
  return (
    <div
      id="about"
      className={cn(
        "group relative flex h-[340px] w-full items-center justify-center bg-white dark:bg-black my-10 lg:my-20",
        containerClassName
      )}
...
export const Highlight = ({ children, className }) => {
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-indigo-800 to-indigo-300 px-1 pb-1 dark:from-indigo-500 dark:to-purple-500`,
        className
      )}
    >
      {children}
